...
//рамке и вокруг. Тогда сектор рисовался радиусом ВПИСАННОЙ окружности (r=46 при окне
//96); с V122 сектор — НЕВИДИМАЯ маска тёмной копии иконки, с V125 радиус вновь больше
//окна (полудиагональ) — см. комментарий внутри функции.
function createNativeSector(place, cx, cy, r, clipW, obj = {}) {
    const ws = createNativeGraphics(place)
    //V125 (репорт юзера: «виден край круга кулдауна на иконке»): кламп r ≤ clipW/2-2
    //(страховка V110 для ВИДИМОЙ тёмной заливки сектора) удалён — сектор теперь только
    //МАСКА (V122): он невидим и обязан накрывать весь квадрат иконки вплоть до углов
    //(радиус вызывающего = полудиагональ), маска больше маскируемого спрайта безвредна
