...
import { portalUse, puzzleButtonUse } from "../scripts/portalFx.js"
...
function finishUsedObject(obj) {
    ...
    //V83: кнопка загадки (21) — с обычным звуком «использования»
    (obj[2] === 3||obj[2] === 10||obj[2] === 11||obj[2] === 12||obj[2] === 6||obj[2] === 15||obj[2] === 16||obj[2] === 17||obj[2] === 18||obj[2] === 19||obj[2] === 20||obj[2] === 21) ? playback(strike[13].vol,0,0,2*status.settings.soundVolume) : playback(strike[1].vol,0,0,5*status.settings.soundVolume)
    if(obj[2] === 15) {
        ...
        //столба 15): флип себя и соседей по логической сетке 3×3 делает portalFx.js;
    ...
    Array.isArray(libObj) && !(obj[2] === 13 && status.levelFloor === 3) && obj[2] !== 18 && obj[2] !== 19 && obj[2] !== 21 && (libObj[obj[2] === 15 ? 55 : obj[2] === 14 ? (obj[10] === 3 ? 14 : obj[10] === 4 ? 34 : 54) : obj[2] + status.levelFloor * 20] = 1)
    stopUseObject()
    ...
    obj[2] !== 15 && obj[2] !== 17 && obj[2] !== 18 && obj[2] !== 19 && obj[2] !== 20 && obj[2] !== 21 && (obj[7] = 1)
