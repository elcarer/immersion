...
function finishUsedObject(obj) {
    ...
    //V133→V135 (репорт юзера): доп. серый предмет — ТОЛЬКО из объектов, у которых уже
    //есть дроп (сундуки/бочки/шкафы — типы 1,2,4,5,6,7,8,9,11); рычаги/порталы/алтари
    //и спуск (13) мимо. Квест «Корм слизи» активен
    ;(obj[2] === 1 || obj[2] === 2 || obj[2] === 4 || obj[2] === 5 || obj[2] === 6 ||
      obj[2] === 7 || obj[2] === 8 || obj[2] === 9 || obj[2] === 11) && slimeQuestExtraDrop(obj)
