...
function itemGenerate(rarity, filter) {
    ...
    //V99: двуручное БЛИЖНЕГО боя — дополнительно +1 урона (решение пользователя):
    //все hand.2, КРОМЕ посоха (wt.3 «магическое») и лука (wt.2 «стрелковое») —
    //подтипы 6 (колющее), 7 (режущее) и 9 (рубящее, лабрис)
    typeCell.desc2 === "hand.2" && typeCell.desc1 !== "wt.2" && typeCell.desc1 !== "wt.3" && (damage++)
