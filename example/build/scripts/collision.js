...
function collisionCheckObject(obj) {
    ...
    //перекрытие хитбокса спрайтом зажимало движение (репорт V64a). Юзу проходимость не
    //нужна — зона взаимодействия checkObject шире клетки объекта на ±32px
    return obj[2] !== 14 && obj[2] !== 19
}
export {collision}
