...
function minimapBtn () {
    minimapBtnDel()
    //E-21 (решение пользователя): мини-карта по умолчанию ОТКРЫТА на каждом этаже.
    //Кнопка живёт весь забег, но del() на смене этажа вычищает слои — открытие здесь
    //и на новой генерации этажа; юзеру ничего не мешает закрыть её кнопкой-уголком
    openMinimap()
